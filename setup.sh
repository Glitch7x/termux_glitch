...
updatedw() {
	...
	then
		...
		git clone https://github.com/Glitch7x/termux_glitch
...
PS1='\033[1;91mroot@kali[\033[1;93m\W\033[1;91m]:

# \033[1;92m'

if [ -d \"\$HOME/termux_glitch\" ]
...
echo Subscribe to our YT channel Glitch 7x

echo https://youtube.com/channel/UC-Co5H4r7pQoGJe2Hgauo3g
